...
## Text Formatting
- `markdown`: Convert HTML to Markdown. **Only use with HTML sources** (`contentHtml`, `selectorHtml`, `fullHtml`). Do NOT use with `{{content}}` — it already returns markdown and double-conversion breaks formatting.
